...
file = read.table("Hubs_Spearman.txt" , sep = "\t" , header = T)
...
ggsave("../Sup_Fig4a_HubIdentification.pdf" , resultplot  , width = 25, height = 4, units = "in")
resultplotb = ggarrange(plotlist = plotsCCBC[6],nrow=1 )
ggsave("../Sup_Fig4b_HubIdentification.pdf" , resultplotb  , width = 10, height = 7, units = "in")
